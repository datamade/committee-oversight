...
NAME=Committee Oversight Production
...
EMAIL=committeeoversight-production@datamade.us
...
SERVER=committeeoversight-production.datamade.us
...
# NOTICE: if your key is encrypted with gpg version >= 2.0.0, UNCOMMENT L87 and
# COMMENT OUT L86.
...
#	ssh ubuntu@$(SERVER) 'sudo -u datamade -H gpg2 --import /home/datamade/.gnupg/$(PROJECT)/private.key'
